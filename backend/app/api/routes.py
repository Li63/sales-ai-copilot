...
## 第一步：完善我的资料
在 **我的** 页填写行业和客户群体，生成销售指南。再上传公司资料，包括产品介绍、报价政策、成功案例、售后规则和常见问题。公司资料越完整，DeepSeek 给出的回复越贴近业务。
...
## 第三步：导入聊天记录
可以粘贴聊天文本，也可以上传聊天截图。系统会先用 **Qwen3-VL** 做 OCR 和图片理解，提取纯文本后，再交给 **DeepSeek** 做客户全景、意向判断和话术分析。
...
## 两模型分工
**Qwen3-VL**：只负责图片 OCR 和信息提取。

**DeepSeek**：负责最终文本输出、销售判断、客户全景分析、话术建议、跟进策略和复盘总结。
""",
        }
    )
